...
srun python ./dg_predictiction.py -a pred_sfx -c 2017W -b "bpic2017W.h5" -v "d_action" -r 1
srun python ./dg_predictiction.py -a pred_sfx -c 2017W -b "bpic2017W.h5" -v "random_choice" -r 1
srun python ./dg_predictiction.py -a pred_sfx -c 2017W -b "bpic2017W.h5" -v "arg_max" -r 1
