#!/bin/bash
#SBATCH -J ConsultaDataMining201618
...
srun python ./dg_predictiction.py -a pred_sfx -c ConsultaDataMining201618 -b "ConsultaDataMining201618.h5" -v "d_action" -r 1 
srun python ./dg_predictiction.py -a pred_sfx -c ConsultaDataMining201618 -b "ConsultaDataMining201618.h5" -v "random_choice" -r 1
srun python ./dg_predictiction.py -a pred_sfx -c ConsultaDataMining201618 -b "ConsultaDataMining201618.h5" -v "arg_max" -r 1
