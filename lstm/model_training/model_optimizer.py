...
# def HMMS_training(durations, waiting,parms):
#
#     # Extracting duration values
#     training_instances = durations
#
#     model,scaler = hm.HMMS_training(durations)
#
#     # # Ensure the directory structure exists
#     # output_directory = os.path.join(parms['output'], 'optimizer')
...
class ModelOptimizer():
    ...
    def execute_trials(self):
        def exec_pipeline(trial_stg):
            ...
            #trianing a HMMM
            # durations, waiting =vectorizer.times_vector(log,trial_stg)
            # self.optimizer,self.scaler = HMMS_training(durations, waiting,self.parms)# this will store a HMMmodel for testing
